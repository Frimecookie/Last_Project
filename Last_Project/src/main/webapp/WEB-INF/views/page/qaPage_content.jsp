					...
					<div class="col-9 col-12-medium imp-medium">
						<div class="content">
							...
							<article class="box page-content" style="height: 600px;">
								<form id="qaContentForm" action="${cpath}/qaPage_update.do"
									method="GET">
									<input type="hidden" id="questions_num" name="questions_num"
										value="${questionsData.questions_num}">
									<header>
										<h2>내 글 보기</h2>
									</header>
									...
									<input type="submit" class="write_button" style="background-color: #2E8B57;" value="수정">
								</form>
								<form id="qaRemoveForm" action="${cpath}/qaPage_remove.do"
									method="POST">
									<input type="hidden" name="questions_num"
										value="${questionsData.questions_num}" /> 
										<input type="submit" id="questionsRemoveBtn" class="write_button" 
										style="margin-right: 1em; background-color: #DB7093;" value="삭제" />
								</form>
							</article>
						</div>
					</div>
