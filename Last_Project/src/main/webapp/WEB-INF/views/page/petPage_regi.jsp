						...
						<div class="content">
							...
							<form action="/petPage_regi.do" method="post">
								<article class="box page-content" style="height: 500px;">
									...
									<input type="text" id="petName" name="pet_name" maxlength="11"
										placeholder="이름을 입력해주세요" required>
									<h3>
										<label for="PET_AGE">반려동물 출생연도</label>
									</h3>
									<input type="text" id="petYob" name="pet_age" maxlength="4"
								...
								<article class="box page-content">
									<span class="image featured" id="tempUploadImgWrap"> <img
										class="temp-upload-img" style="margin: 0 auto;" src="">
									</span> <input type="hidden" id="internalImgPath"
										name="INTERNAL_IMGPATH"> <input type="hidden"
										id="externalImgPath" name="pet_picture"><br>
