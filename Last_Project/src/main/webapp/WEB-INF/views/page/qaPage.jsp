					...
					<div class="col-9 col-12-medium imp-medium">
						<div class="content">
							...
							<article class="box page-content" style="height: 600px;">
									...
									<c:forEach var="qna" items="${qnalist}">
										<form id="qnaForm" action="${cpath}/qaPage_content.do"
											...
											<tr>
												...
												<td width="150"><input type="submit"
													value="${qna.questions_title}"
													style="font-size: 15px; background: none; color: #696969; "></td>
												<td>${qna.user_id}</td>
												<td><fmt:formatDate value="${qna.questions_date}"
								...
								<c:if test="${!empty mvo}">
									<a href="qaPage_write.do"><input type="button" class="write_button" value="문의하기"></a>
								</c:if>
								<c:if test="${empty mvo}">
									<a href="loginPage.do"><input type="button" class="write_button" value="문의하기"></a>
								</c:if>
							</article>
						</div>
					</div>
