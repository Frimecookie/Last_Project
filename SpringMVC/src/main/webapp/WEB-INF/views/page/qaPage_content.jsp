                     ...
                     <div class="col-9 col-12-medium imp-medium">
                        <div class="content">
                           ...
                           <article class="box page-content" style="height: 600px;">
                              <form id="qaContentForm" action="${cpath}/qaPage_update.do" method="GET">
                                 ...
                                 <table>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          <textarea name="QUESTIONS_CONTENT" readonly="readonly">${questionsData.questions_content}</textarea>
                                       </td>
                                    </tr>
                                 </table>
<!--                                  <a href="qaPage.do"><input type="submit" style="margin-top: 10px; position: relative; right: 240px; float: right;" value="목록"></a>  -->
                                 <input type="submit" style="margin-top: 10px; position: relative; right: 270px; float: right;" value="수정">
                              </form>
