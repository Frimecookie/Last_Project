...
<body class="is-preload">
	<div id="page-wrapper">
		...
		<section id="main">
					...
					<div class="col-9 col-12-medium imp-medium">
						<div class="content">
							...
							<article class="box page-content">
								...
								<!-- <video src="/resources/videos/video.mp4" controls width="720px" height="480px" autoplay muted></video> -->
			...
			<input type="image" src="/resources/images/top.png"
			...
			<div class="container">
							...
							<div class="info">
								<div id="info__id">
									<input type="text" placeholder="이메일을 입력해주세요"
										style="width: 800px; height: 50px; font-size: 20px;" />
									<button>구독하기</button>
								</div>
							</div>
						</section>
				...
				<div id="copyright">
					<ul class="menu">
						...
						<li>Team: <a href="http://html5up.net">dbdbDeep</a></li>
					</ul>
				</div>
			</div>
		</footer>
