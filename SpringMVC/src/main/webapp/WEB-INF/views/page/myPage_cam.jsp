								...
								<div class="content">
									...
									<!-- Content -->
										...
										<article class="box page-content" style="height: 500px;">
											...
											<table>
												<tr>
													<td style="font-size: 20px;"><b>캠번호</b></td>
													<td style="font-size: 20px;">20230308</td>
													<td><input type="button" value="삭제하기" style="padding: 10px 30px;"></td>
												</tr>
												<tr>
													<td style="font-size: 20px;"><b>캠번호</b></td>
													<td style="font-size: 20px;">20230309</td>
													<td><input type="button" value="삭제하기" style="padding: 10px 30px;"></td>
												</tr>
												<tr>
													<td style="font-size: 20px;"><b>캠번호</b></td>
													<td style="font-size: 20px;">20230310</td>
													<td><input type="button" value="삭제하기" style="padding: 10px 30px;"></td>
												</tr>
											</table>
											<br><br>
											<input type="button" value="등록하기" style="position: relative; left: 300px;">
										</article>
								</div>
							</div>
						</div>
