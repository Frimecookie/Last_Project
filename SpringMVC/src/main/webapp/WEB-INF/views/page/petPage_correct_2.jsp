							...
							<div class="col-9 col-12-medium imp-medium">
								<div class="content">
									...
									<!-- Content -->
										...
										<article class="box page-content" style="height: 400px;">
											...
											<form>
												<h3><label for="petName">반려동물 이름</label></h3>
												<input type="text" id="petName" name="petName" maxlength="11" placeholder="이름을 입력해주세요" required>
												<h3><label for="petGender">반려동물 성별</label></h3>
												<input type="radio" id="petGender" name="petGender" value="male">남성
												<input type="radio" id="petGender" name="petGender" value="female">여성
												<h3><label for="petYob">반려동물 출생연도</label></h3>
												
												<input type="text" id="petYob" name="petYob" maxlength="4" placeholder="YYYY" pattern="\d{4}">
											</form>	
										</article>		
										...
										<article class="box page-content">
											<form>
												...
												<span class="image featured"><img src="images/dog01.jpg" style="width: 300px; height: 300px; border-radius: 100%; margin-left: 175px; margin-top: 30px;" /></span>
												<div class="filebox">
													<input class="upload-name" placeholder="사진파일">
													<label for="file">파일찾기</label> 
													<input type="file" id="file">
												</div>

												<input type="submit" style="margin-top: 20px;" value="수정하기">
											</form>
